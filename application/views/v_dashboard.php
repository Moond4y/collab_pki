           ...
           <div class="col-md-12">
            <div class="card  card-plain">
              <div class="card-header">
                <h4 class="card-title"> Silahkan tekan tombol "Download Digital Signature" untuk mengunduh digital signature anda.</h4>
              </div>
                  <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div>
                      <a href="<?php echo base_url(); ?>index.php/fungsi/downloadds" target="_blank" class="btn-block btn btn-success btn-md">Download Sertifikat Digital</a>
                </div>
              </div>
            </div>
          </div>
