...
<head>
  <title>Kelompok PKI | Login</title>
  <!-- Meta-Tags -->
  ...
  <meta name="keywords" content="">
    ...
    <body style="overflow-x: hidden">
      <h1 class="title-agile text-center">Sistem Informasi Digital Signature HIMA</h1>
      <div class="row">
        <div class="col-md-6 col-xs-12" style="padding-right:20px; border-right: 2px solid #ccc;">
          ...
          <p style="margin-left: 50px;margin-right: 50px;font-weight: 600; letter-spacing: 1px; font-size: 1em;line-height: 1.4">
            Ini merupakan halaman website Sistem Informasi Digital Signature Himpunan Mahasiswa STSN. Website ini memberikan mahasiswa akses terhadap digital signature miliknya yang dapat diunduh setelah melakukan login.</p>
        </div>
